...
**Coordinates:** RA 21 53 24 / Dec +47 16 00
...
<li class="sb-stage excluded">
<div class="sb-stage-head"><a class="sb-stage-name" href="https://raw.githubusercontent.com/geeksville/starbash-recipes/v0.3.3/palette/sho.toml">palette_sho</a> <span class="sb-tool">siril</span> <span class="sb-skip">skipped</span> <span class="sb-stage-desc">SHO palette: R=Ha, G=Sii-or-synthetic, B=OIII</span></div>
<ul class="sb-params">
...
<li class="sb-param" title="Width to crop the stacked image to before palette assembly (0 = no crop). Use original width minus ~2x the stack feather width to remove feathered border pixels."><span class="sb-pname">crop_width</span> <span class="sb-default">(no default)</span></li>
<li class="sb-param" title="Height to crop the stacked image to before palette assembly (0 = no crop)."><span class="sb-pname">crop_height</span> <span class="sb-default">(no default)</span></li>
</ul>
</li>
<li class="sb-stage">
